    ...
    <el-table :data="refunds" style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="amount" label="退款金额">
        <template #default="{ row }">
          {{ formatAmount(JSON.parse(row.amount).refund) }} 元
        </template>
      </el-table-column>
    ...
    >
      <el-form :model="approveForm" label-width="100px">
        ...
        <el-form-item label="退款金额">
          <span>{{ formatAmount(JSON.parse(approveForm.amount).refund) }} 元</span>
        </el-form-item>
    ...
    >
      <el-descriptions :column="1" border>
        ...
        <el-descriptions-item label="退款金额">
          {{ formatAmount(JSON.parse(currentRefund.amount).refund) }} 元
