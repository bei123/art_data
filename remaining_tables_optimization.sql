-- 剩余表优化脚本
-- 优化 digital_artworks, wx_users, artists, user_sessions, institutions, physical_categories, banners, favorites
...
-- 主要查询模式：WHERE openid = ?（登录查询）
-- 这个索引已经存在，但我们需要确保它是最优的
-- CREATE INDEX openid ON wx_users(openid);
